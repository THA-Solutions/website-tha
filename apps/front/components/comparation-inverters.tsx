...
interface ComparacaoInversoresProps {
  idInverter1: string;
  idInverter2: string;
}

const ComparacaoInversores: React.FC<ComparacaoInversoresProps> = ({ idInverter1, idInverter2 }) => {
...
export default ComparacaoInversores;
