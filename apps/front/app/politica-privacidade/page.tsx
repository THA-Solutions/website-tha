    ...
    <>
      <section className="flex flex-col space-y-4">
        <p className="text-xl text-gray-300 text-justify sm:text-left">
          A sua privacidade é importante para nós. É política do THA
          Solutionsrespeitar a sua privacidade em relação a qualquer informação
          sua que possamos coletar no site THA Solutions, e outros sites que
      ...
      <section className="flex flex-col space-y-4">
        ...
        <p className="text-xl text-gray-300 text-justify sm:text-left">
          ...
          informação que o THA Solutions oferece no site e com caráter
        ...
        <ol className="text-xl text-gray-300 text-justify sm:text-left">
          ...
          <li>
            ...
            betano apostas ou azar, qualquer tipo de pornografia ilegal, de
            apologia ao terrorismo ou contra os direitos humanos;
          </li>
          <li>
            Não causar danos aos sistemas físicos (hardwares) e lógicos
            (softwares) do THA Solutions, de seus fornecedores ou terceiros,
      ...
      <section className="flex flex-col space-y-4">
        <h1 className="text-3xl font-bold text-white">MAIS INFORMAÇÕES</h1>
        <p className="text-xl text-gray-300 text-justify sm:text-left">
